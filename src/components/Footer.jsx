    ...
    return (
        <footer className="bg-primary text-white relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0">
                <svg className="w-full h-12 text-lightBg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h3 className="text-xl font-bold">E+ للدهانات</h3>
                                <p className="text-sm text-white/70">جودة وتميز</p>
                            </div>
                        </div>
                        <p className="text-white/80 leading-relaxed mb-6">
                            نقدم خدمات دهان احترافية بأعلى معايير الجودة في جميع أنحاء المملكة العربية السعودية
                        </p>
                        <div className="flex gap-3">
                            {socialLinks.map((social, index) => (
                                <a
                                    ...
                                    className="w-10 h-10 bg-white/10 hover:bg-accent rounded-premium flex items-center justify-center transition-all duration-300 hover:scale-110"
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-white/80" dir="ltr">+966 55 785 2506</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <svg className="w-6 h-6 text-accent flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-white/80">السبت - الخميس</p>
                                    <p className="text-white/80">8 صباحاً - 8 مساءً</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-white/10 pt-8 mt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-white/70 text-center md:text-right">
                            © {currentYear} E+ للدهانات. جميع الحقوق محفوظة
                        </p>
